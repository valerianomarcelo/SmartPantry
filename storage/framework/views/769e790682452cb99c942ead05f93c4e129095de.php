  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="#">
        <img src="<?php echo e(asset('images/logoSmartPantry.jpg')); ?>" alt="SmartPantry Logo">
      </a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        ...
        <a class="btn btn-primary mr-2" href="<?php echo e(route('login')); ?>">Login</a>
        <a class="btn btn-secondary" href="<?php echo e(route('register')); ?>">Registrar</a>
      </div>
    </nav>
	...
	<section id="benefits" class="section">
	  <div class="container">
		...
		<div class="row">
		  <div class="col-md-5">
			<img src="<?php echo e(asset('images/img01.jpg')); ?>" alt="Benefício 1">
		  </div>
		...
		<div class="row mt-4">
		  ...
		  <div class="col-md-6">
			<img src="<?php echo e(asset('images/img03.jpg')); ?>" alt="Benefício 2">
		  </div>
		</div>

		<div class="row">
		  <div class="col-md-5">
			<img src="<?php echo e(asset('images/img02.jpg')); ?>" alt="Benefício 3">
		  </div>
		  <div class="col-md-7 d-flex align-items-center">
		...
		<div class="row">
		  <div class="col-md-6">
			<div class="d-flex align-items-center justify-content-center h-100">
			  <img src="<?php echo e(asset('images/cashier-register-concept-vetor.jpg')); ?>" alt="Imagem de Funcionalidades" class="img-fluid">
			</div>
		  </div>
		  <div class="col-md-6">
	...
	<section id="partners" class="section">
	  <div class="container">
		...
		<div class="row text-center">
		  <div class="col-md-12">
			<div class="partners">
			  <img src="<?php echo e(asset('images/logoepa.png')); ?>" alt="Parceiro 1">
			  <img src="<?php echo e(asset('images/logobh.png')); ?>" alt="Parceiro 2">
			  <img src="<?php echo e(asset('images/logoabc.png')); ?>" alt="Parceiro 3">
			  <img src="<?php echo e(asset('images/logomineirao.png')); ?>" alt="Parceiro 4">
			  <img src="<?php echo e(asset('images/logoapoio.png')); ?>" alt="Parceiro 5">
			  <img src="<?php echo e(asset('images/logodia.png')); ?>" alt="Parceiro 6">
			</div>
		  </div>
		</div>
		<div class="row mt-5">
		...
		<div class="row">
		  <div class="col-md-6 text-center">
			<a href="#" class="download-link">
			  <img src="<?php echo e(asset('images/googleplay.png')); ?>" alt="Download no Google Play" class="download-img">
			</a>
		  </div>
		  <div class="col-md-6 text-center">
			<a href="#" class="download-link">
			  <img src="<?php echo e(asset('images/appstore.png')); ?>" alt="Download na App Store" class="download-img">
			</a>
		  </div>
		</div>
	  </div>
...
<?php /**PATH E:\Marcelo\Projetos\SmartPantry\resources\views/landingpage.blade.php ENDPATH**/ ?>